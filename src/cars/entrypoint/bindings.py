...
import inject
from cars.core.domain.car_repository import CarRepository
from cars.core.services.car_list_service import CarListService
from cars.entrypoint.config import Config
from cars.infrastructure.database.repositories.cars import PostgreSQLCarRepository
from cars.infrastructure.database.repositories.get_mapping_callbacks import get_mapping_callbacks
